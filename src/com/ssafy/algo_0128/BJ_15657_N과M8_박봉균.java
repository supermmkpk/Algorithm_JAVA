 ...
 * @author 박봉균
 * @since JDK17
 * @see <a href="https://www.acmicpc.net/source/72517857"></a>
 * 
 * 결과: "맞았습니다!!", 309576KB, 988ms
 */

/*
 * 1부터 N까지 자연수(모두 다른 수) 중에서 M개를 고른 수열을 구하라.(같은 수 중복 OK, 비내림차순)
[입력]
1) N, M (1 ≤ M ≤ N ≤ 8)
2) N개의 수. (<= 10,000)
[출력]
 ...
 */
public class BJ_15657_N과M8_박봉균 {
	static int N, M;
	/** 결과 리스트 */
